...
public class ClassLib extends ClassUtils {
    ...
    private static Logger logger = LoggerFactory.getLogger(ClassLib.class);
    ...
    public static String getAttributeNameByMethod(String methodName) {
        if (!StringLib.isEmpty(methodName)) {
            if (methodName.toLowerCase().startsWith("set") || methodName.toLowerCase().startsWith("get")) {
                methodName = methodName.substring(3);
            }
            if (methodName.toLowerCase().startsWith("is")) {
                methodName = methodName.substring(2);
            }
            methodName = org.apache.commons.lang3.StringUtils.uncapitalize(methodName);
        }
        return methodName;
    }
    ...
    public static Class getClass(String instance) {
        try {
            return ClassUtils.getClass(instance);
