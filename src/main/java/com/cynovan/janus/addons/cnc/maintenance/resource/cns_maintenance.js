define([], function () {
    ...
    app.controller('maintenanceController', ['$scope', '$state', 'DBUtils', 'dialog', 'http', '$element', 'SecurityService',
        ...
        _.extend(ctrl, {
            ...
            bindEvent: function () {
                $scope.$on('buttonClicked.list', function (event, element, options, rowdata) {
                    ...
                    if (buttonKey === "maintenanceEditBtn") {
                        ctrl.showMaintenanceDetail(rowdata.id);
                    }
                    if (buttonKey === "maintenanceDelBtn") {
                ...
                if (id) {
                    DBUtils.find('maintenance', {
                        ...
                        var editMaintenance = dialog.show({
                            template: 'cns_add_maintenance_template',
                            width: 1200,
                            title: false,
    ...
    app.controller('MaintenanceAddController', ['$scope', 'DBUtils', 'dialog', 'http', 'util', '$timeout', 'AppComponent', function ($scope, DBUtils, dialog, http, util, $timeout, AppComponent) {
        var ctrl = this;
