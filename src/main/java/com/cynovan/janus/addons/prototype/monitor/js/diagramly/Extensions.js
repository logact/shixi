...
//Network
        'Image_network_server': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Server_Tower_128x128.png;flipH=1',
        'Image_network_server_file': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Server_128x128.png',
        'Image_network_server_net': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/networking/Print_Server_128x128.png',
        'Image_network_server_net_large': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Server_128x128.png',
        'Image_network_raid': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Server_Tower_128x128.png;flipH=1',
        'Image_network_raid_large': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Server_Tower_128x128.png;flipH=1',
        'Image_network_rack_server': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Server_Rack_128x128.png',
        'Image_network_rack_tape': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Server_Rack_Partial_128x128.png',
        'Image_network_printer_small': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Printer_128x128.png;flipH=1',
        'Image_network_printer_large': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Printer_128x128.png;flipH=1',
        'Image_network_printer_multipurpose': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Printer_Commercial_128x128.png;flipH=1',
        'Image_network_copier_small': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Printer_Commercial_128x128.png',
        'Image_network_copier_large': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Printer_Commercial_128x128.png',
//			'Image_network_printer_largeformat' NA
        'Image_network_router': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/networking/Router_128x128.png',
        'Image_network_router_wireless': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/networking/Wireless_Router_128x128.png',
        'Image_network_ups': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/networking/UPS_128x128.png',
//Electronics
...
//			'Image_electronics_speakers_5_1' NA
        'Image_electronics_lcd': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Monitor_128x128.png',
        'Image_electronics_pda': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/telecommunication/Palm_Treo_128x128.png',
        'Image_electronics_drive_cardreader': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/finance/Credit_Card_128x128.png',
        'Image_electronics_camcorder': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/networking/Ip_Camera_128x128.png',
//			'Image_electronics_headset' NA
//			'Image_electronics_calculator_simple' NA
//			'Image_electronics_scanner_flatbed' NA
        'Image_electronics_printer_photo': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Printer_128x128.png;flipH=1',
//			'Image_electronics_scanner_photo' NA
//			'Image_electronics_projector' NA
        'Image_electronics_drive_firewire': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Harddrive_128x128.png;flipH=1',
        'Image_electronics_drive_usb': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Harddrive_128x128.png;flipH=1',
        'Image_electronics_modem_external': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/networking/Modem_128x128.png;flipH=1',
//			'Image_electronics_tv_tuner_external' NA
//			'Image_electronics_mp3' NA
//			'Image_electronics_sound_box' NA
        'Image_electronics_lcd_wide': 'image;image=' + window.GRAPH_IMAGE_PATH + 'img/lib/clip_art/computers/Monitor_128x128.png',
//Audio Equipment
