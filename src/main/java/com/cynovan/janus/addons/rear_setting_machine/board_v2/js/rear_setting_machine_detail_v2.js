define(['rear_setting_machine/board_v2/js/rear_setting_machine_data_config_v2', "echarts"], function (AppDataConfig, echarts) {
    var app = angular.module('app');

    app.controller('RearSettingMachineDetailV2Controller', ['$scope', '$stateParams', 'DBUtils', 'util', 'websocket', 'dialog', '$element', 'session', 'AppConfigService', '$timeout', '$state', 'janus',
        function ($scope, $stateParams, DBUtils, util, websocket, dialog, $element,
            ...
            var appName = 'rear_setting_machine_board_v2';
            ...
            ctrl.subNavOptions = {
                collection: 'device',
                query: {'rear_setting_machine_v2.show': true}
            };
            ...
            _.extend(ctrl, {
                ...
                bindEvent: function () {
                    $scope.$watch('entity.rear_setting_machine_v2.image_id', function (newValue, oldValue) {
                        if (!_.isUndefined(newValue)) {
                            if (newValue !== oldValue) {
                                DBUtils.update('device', {
                                    ...
                                    $set: {
                                        'rear_setting_machine_v2.image_id': newValue
                                    }
                                }).success(function () {
                                    dialog.noty('操作成功');
                                });
