define(['rear_setting_machine/board/resource/rear_setting_machine_data_config'], function (AppDataConfig) {
    var app = angular.module('app');

    app.controller('RearSettingMachineBoardController', ['$scope', '$state', 'DBUtils', 'dialog', 'http', '$element', 'util', 'database',
        ...
        function ($scope, $state, DBUtils, dialog, http, $element, util, database, AppConfigService, BindDevice, $timeout, janus) {
            ...
            _.extend(ctrl, {
                ...
                initKanbanOptions: function () {
                    var query = {'rear_setting_machine.show': true};
                    ctrl.kanbanOptions = {
                        collection: 'device',
                        query: query,
                        projector: {},
                ...
                getRearImageUrl: function (itemData) {
                    var imageId = _.get(itemData, 'rear_setting_machine.image_id', '');
                    if (imageId) {
                ...
                bindDeviceToRearSettingMachine: function () {
                    BindDevice.bind('rear_setting_machine.show').done(function () {
                        ctrl.refreshTable();
                    });
                },
